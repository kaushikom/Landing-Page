...
const Cyl = () => {
   const [isHovered, setIsHovered] = useState(false);
    let tex = useTexture(Logo);
     tex.anisotropy = 16;
    let cyl = useRef(null);
    // Rotate the cylinder only when not hovered
  ...
  return (
    <mesh
     onPointerOver={() => setIsHovered(true)} // Stop rotation on hover
        onPointerOut={() => setIsHovered(false)} // Resume rotation when hover ends
    ref={cyl}>
...
//           uniforms={{
//             map: { value: tex },
//             saturation: { value: 1 } // Adjust this to change saturation
//           }}
