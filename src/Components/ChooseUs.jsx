...
const ChooseUs = () => {
  return (
    <section className='flex flex-col justify-center py-12 blue-blur sm:flex-row'>
{/* Content */}
<div className='max-w-[90ch]'>
    <h2 className='text-6xl text-white unbounded'>The Code Backward Lab Advantage </h2>
    <h5 className='my-12 text-2xl text-off-white inter'>Startups Trust Us to Deliver Results Without Sacrificing Ownership or Overspending </h5>
    <p className='text-lg font-semibold text-off-white my-4 max-w-[70ch]'>When you work with us, you don’t just get technical advice—you get a true partner invested in your success. Here’s why startups choose us: </p>
