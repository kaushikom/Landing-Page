...
const Services = () => {
  return (
    <section className='px-4 py-4 my-8 rounded-lg bg-blue'>
        ...
        <p className='mx-auto text-lg sm:text-xl text-center sm:w-[50ch] text-off-white'>On-Demand Tech Co-founder Services to Help You Build, Scale, and Automate—Without Breaking the Bank </p>
