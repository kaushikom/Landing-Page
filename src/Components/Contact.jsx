...
const Contact = () => {
  return (
    <section className='px-6'>
        ...
        <div className='flex flex-wrap justify-between gap-8 my-8 sm:mx-auto md:w-3/5'>
            <input placeholder='Company Name' type="text" name='company-name' className='w-full px-4 py-2 text-lg text-white bg-black border-2 outline-none sm:w-[45%] sm:text-xl placeholder:text-light-grey sora border-light-grey caret-blue focus:border-blue' />
            <CustomDatePicker />    
        </div>
        <div className='flex flex-wrap justify-between gap-8 my-8 sm:mx-auto md:w-3/5'>
            <StyledSelect />
        ...
        <div className='flex flex-wrap justify-between gap-8 my-8 sm:mx-auto md:w-3/5'>
            <textarea placeholder='Brief description of your startup' name="" id="" className='w-full px-4 py-2 sm:text-xl text-lg text-white h-[150px] bg-black border-2 outline-none placeholder:text-light-grey sora border-light-grey caret-blue focus:border-blue'></textarea>
        </div>
